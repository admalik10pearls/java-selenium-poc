...
- Add a `docs/` folder with an Architecture doc that diagrams the packages.
- Create a small CI workflow for GitHub Actions that runs `mvn test`.
- Update `pom.xml` to a recommended Java version (for example, 17) — tell me which Java version you prefer and I can change it.
